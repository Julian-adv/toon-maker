...
<div class="content-container">
  ...
  <div class="options-container">
    ...
    <button class="nav-button nav-left" onclick={goToPreviousImage} aria-label="Previous image">
    ...
    <button class="nav-button nav-right" onclick={goToNextImage} aria-label="Next image">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
        ><path
          fill="none"
          stroke="currentColor"
